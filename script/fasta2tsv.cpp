...
"fasta2tsv input.fasta output.tsv\n"
"    convert FASTA format alignment to tab-eliminated table\n"
;
...
int fasta2tsv(const string infile="-", const string outfile="-")
{
    ifstream fp_in;
    ofstream fp_out;
